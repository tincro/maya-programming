...
class LightManager(QtWidgets.QWidget):
    """Creates floating widget manager for Lights in the scene"""
    ...
    def populate(self):
        # TODO: Change this later to populate the list for all lights in SCENE
    ...
    def importLights(self):
        ...
        for light, info in properties.items():
            ...
            for lt in self.lightTypes:
                ...
                logger.info('Cannot find corresponding lightType for %s (%s)' % (light, lightType))
                continue
...
class LightWidget(QtWidgets.QWidget):
    ...
    # Custom PySide2 Signal. Within class, outside methods.
    onSolo = Signal(bool)
